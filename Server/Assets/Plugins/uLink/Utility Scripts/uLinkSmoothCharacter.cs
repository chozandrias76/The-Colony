...
/// <summary>
///     A script example that can be use for players' avatars in a game where the server is authoritative or
///     non-authoritative.
/// </summary>
/// <remarks>
...
///     character. If you want to add security checks in the server because it should be authoritative, you can do that.
///     Make a
...
public class uLinkSmoothCharacter : MonoBehaviour
{
    ...
    private void SendToServer()
    {
        ...
        networkView.UnreliableRPC("Move", NetworkPlayer.server, transform.position, character.velocity,
            transform.rotation);
    }
