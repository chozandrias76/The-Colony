...
{
    private const float BONUS_TICKS = 2.5f; // give exta ticks to more accurately balance frame time
    ...
    private static extern uint MsgWaitForMultipleObjectsEx(uint nCount, IntPtr[] pHandles, uint dwMilliseconds,
        uint dwWakeMask, uint dwFlags);
    ...
    private void LateUpdate()
    {
        ...
        var prevFrameTicks = (int) unchecked(curTicksSinceStartup - prevTicksSinceStartup);
...
public static class Application
{
    ...
    {
        UnityEngine.Application.ExternalCall(script);
    }

    public static float GetStreamProgressForLevel(int levelIndex)
    {
        return UnityEngine.Application.GetStreamProgressForLevel(levelIndex);
    }

    public static float GetStreamProgressForLevel(string levelName)
    {
        return UnityEngine.Application.GetStreamProgressForLevel(levelName);
    }
    ...
    {
        UnityEngine.Application.LoadLevelAdditive(index);
    }

    public static void LoadLevelAdditive(string name)
    {
        UnityEngine.Application.LoadLevelAdditive(name);
    }

    public static AsyncOperation LoadLevelAdditiveAsync(int index)
    {
        return UnityEngine.Application.LoadLevelAdditiveAsync(index);
    }

    public static AsyncOperation LoadLevelAdditiveAsync(string levelName)
    {
        return UnityEngine.Application.LoadLevelAdditiveAsync(levelName);
    }

    public static AsyncOperation LoadLevelAsync(int index)
    {
        return UnityEngine.Application.LoadLevelAsync(index);
    }

    public static AsyncOperation LoadLevelAsync(string levelName)
    {
        return UnityEngine.Application.LoadLevelAsync(levelName);
    }
    ...
    public static void RegisterLogCallback(UnityEngine.Application.LogCallback handler)
    {
        UnityEngine.Application.RegisterLogCallback(handler);
    }
    ...
    {
        get { return UnityEngine.Application.absoluteURL; }
    }

    public static ThreadPriority backgroundLoadingPriority
    {
        get { return UnityEngine.Application.backgroundLoadingPriority; }
    ...
    {
        get { return UnityEngine.Application.isLoadingLevel; }
    }
    ...
    {
        get { return UnityEngine.Application.isWebPlayer; }
    }

    public static int levelCount
    {
        get { return UnityEngine.Application.levelCount; }
    }

    public static int loadedLevel
    {
        get { return UnityEngine.Application.loadedLevel; }
    }

    public static string loadedLevelName
    {
        get { return UnityEngine.Application.loadedLevelName; }
    }
    ...
    {
        get { return UnityEngine.Application.runInBackground; }
        set { UnityEngine.Application.runInBackground = value; }
    }

    public static string srcValue
    {
        get { return UnityEngine.Application.srcValue; }
    }

    public static int streamedBytes
    {
        get { return UnityEngine.Application.streamedBytes; }
    }

    public static SystemLanguage systemLanguage
    {
        get { return UnityEngine.Application.systemLanguage; }
    }
    ...
    {
        get { return UnityEngine.Application.webSecurityEnabled; }
    }

    public static string webSecurityHostUrl
    {
        get { return UnityEngine.Application.webSecurityHostUrl; }
    }

    public static NetworkReachability internetReachability
    {
        get { return UnityEngine.Application.internetReachability; }
    }
