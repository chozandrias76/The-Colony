...
///     1. Create a prefab and put it in the Resources folder (NOTE: This location is important. It is not OK with a
///     subfolder).
...
public sealed class uLinkNetworkView : NetworkView
{
}